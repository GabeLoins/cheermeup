...
<<<<<<< HEAD
function sendMail(toEmail, fromEmail, fromName, toName, message, urlJSON) {
=======
...
<<<<<<< HEAD
        html: bodyGenerator(toName, fromName, message, urlJSON),
=======
...
<<<<<<< HEAD
function bodyGenerator(toName, fromName, message, urlJSON) {
...
<<<<<<< HEAD
            ...
            "<div id='content1' class='c'><image src='" + parsed[0] + "' class='content' style='border-radius: 20px; max-width: 500px; margin: auto; display: block;' /></div>" +
            "<div class='spacer' style='width: 550px; height: 12px; background-color: white;'></div><div class='spacer'></div>" +
            "<div id='content2' class='c'><image class='content' class='content' style='border-radius: 20px; max-width: 500px; margin: auto; display: block;' src='" + parsed[1] + "'/></div>" +
            "<div class='spacer' style='width: 550px; height: 12px; background-color: white;'></div><div class='spacer'></div>" +
            "<div id='content3' class='c'><image class='content' class='content' style='border-radius: 20px; max-width: 500px; margin: auto; display: block;' src='" + parsed[2] + "'/></div>" +
            "<div class='spacer' style='width: 550px; height: 12px; background-color: white;'></div><div class='spacer'></div>" +
            "<div id='content4' class='c'><image class='content' class='content' style='border-radius: 20px; max-width: 500px; margin: auto; display: block;' src='" + parsed[3] + "'/></div>" +
            "<div class='spacer' style='width: 550px; height: 12px; background-color: white;'></div><div class='spacer'></div>" +
            "<div id='content5' class='c'><image class='content' class='content' style='border-radius: 20px; max-width: 500px; margin: auto; display: block;' src='" + parsed[4] + "'/></div>" +
            "<div class='spacer' style='width: 550px; height: 12px; background-color: white;'></div><div class='spacer'></div>" +
            "<div class='c' style='padding-left:10px'><p id='promotion'>Want to cheer someone else up? " +
            "<a href='http://www.cheer-me-up.org'> Click here</a> to keep happy times going!</p> " + 
            "<p id='lame'>Don't like happiness? Click here to stop receiving these emails.</p></div><div class='spacer'></div><div height=10px width=500px></div>" + 
=======
            "<strong>&quot;" + message + "&quot;<br>-" + fromName + "</strong></br></div>" + 
